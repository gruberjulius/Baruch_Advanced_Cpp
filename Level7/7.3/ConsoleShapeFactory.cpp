...
std::shared_ptr<Point> ConsoleShapeFactory::CreatePoint() {
	...
	std::cin >> x;
	std::cout << "\t enter the y variable y: ";
	std::cin >> y;
...
std::shared_ptr<Line> ConsoleShapeFactory::CreateLine() {
	double x1, y1, x2, y2;
	std::cout << "Creating Line:\n \tenter the variable x1: ";
	std::cin >> x1;
	std::cout << "\tenter the variable y1: ";
	std::cin >> y1;
	std::cout << "\tenter the variable x2: ";
	std::cin >> x2;
	std::cout << "\tenter the variable y2: ";
	std::cin >> y2;
	//return a shared pointer to the line
...
std::shared_ptr<Circle> ConsoleShapeFactory::CreateCircle() {
	...
	std::cin >> x;
	std::cout << "\tenter the variable y: ";
	std::cin >> y;
	std::cout << "\tenter the variable r: ";
	std::cin >> r;
	return std::make_shared<Circle>(Point(x, y), r);
};

//function to create shapes all at the same time
